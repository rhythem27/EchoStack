...
- [ ] Record a short clip demonstrating real-time voice proxying, vision frame capture, and RAG document search.
- [ ] Convert recording to an optimized GIF/WebP asset and place at the top header of `README.md`.

### 2.2 System Architecture Diagramming
- [ ] Add clean Mermaid.js diagram illustrating client-side audio/video streaming, WebSocket proxy, Kafka worker ingestion, and PostgreSQL `pgvector` HNSW index.

### 2.3 Cost & Latency Optimization Section
- [ ] Write dedicated section breaking down:
...
- [ ] `README.md` features a working demo image/GIF, Mermaid architecture diagram, and comprehensive cost/latency optimization analysis.
